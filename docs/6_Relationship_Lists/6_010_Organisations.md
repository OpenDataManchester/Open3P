...
The organisations relationship list identifies the organisations that part of the packaging supply chain. This is used in the following schemas:
...
* [Load Catalogue](../3_Data_Specification/3_6_Load_Catalogue.md)
