...
|opacity|`required`|Numeric|The transparency of the colours on a 0 to 100% scale. The lower the value, the more transparent; the higher the value, the more solid.|
