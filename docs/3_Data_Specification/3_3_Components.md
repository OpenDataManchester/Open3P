...
|componentConstituents|`required`|List|The information regarding the consituents that are combined to create this component. The entries should be from the [Material Constituents Relationship List](../6_Relationship_Lists/6_004_Component_Constituents.md) identifier.|
...
|componentEndOfLifeRoutes|`recommended`|List|The information regarding this components purposed end of life routes. The entries should be the [component end of life routes](../6_Relationship_Lists/6_007_Component_End_of_Life_Routes.md) identifiers.|
