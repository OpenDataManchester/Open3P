...
|measurements|`mandatory`|List|The information regarding the measurements of the component. The entries should be from the [Measurements Relationship List](../6_Relationship_Lists/6_012_Measurements.md).|
